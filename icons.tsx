...
export const MobileScreenButtonIcon: React.FC<IconProps> = ({
  className,
  style,
}) => (
  <svg
...
export const CheckeredFlagIcon: React.FC<IconProps> = ({
  className,
  style,
}) => (
  <svg
...
export const ClockRotateLeftIcon: React.FC<IconProps> = ({
  className,
  style,
}) => (
  <svg
...
export const RotateLeftIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 512 512"
    fill="currentColor"
    ...
    aria-hidden="true"
  >
    <path d="M48.5 224H40c-13.3 0-24-10.7-24-24V72c0-9.6 5.7-18.2 14.4-22s18.9-2.1 25.9 4.6l19.2 19.2C104.5 23.8 169.9 0 240 0c106 0 199.1 59.2 246.7 146.2c8.7 15.5 15.7 31.9 21 49.1c2.7 8.8 .5 18.4-5.8 25.2l-14.1 15.6c-7.7 8.5-20.9 8.8-28.9 .6l-1.5-1.6c-13.1-15-28.7-27.9-46.3-38.1C381.2 172.8 338.4 160 293.2 160c-60.3 0-114.7 24.5-154.1 64H200c13.3 0 24 10.7 24 24s-10.7 24-24 24H48.5z" />
  </svg>
);
